    ...
    public partial class Form1 : Form
    {
        ...
        public Form1(bool runMinimized)
        {
            ...
            if (File.Exists(Info.datesFileLocation))
            {
                ...
                _autoDelete = infoData.autoDelete;
        ...
        private void Save()
        {
            ...
            infoData.autoDelete = _autoDelete;
        ...
        public void button1_Click(object sender = null, EventArgs e = null)
        {
            ...
            //Reset the log
            File.WriteAllText(Info.failedFilesLocation, "");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //Check to make sure the autodelete is on or off
            if(_autoDelete)
            {
        ...
        //Checking to make sure we can auto-delete
